...
public class XmlFileReaderTest {
    ...
    @Test
    public void shouldReadFile1() throws IOException, InterruptedException {
        //given
        ...
        //when
        String result = xmlFileReader.read(newFilePath);
        //then
    ...
    @Test
    public void shouldReadFile2() throws IOException, InterruptedException {
        //given
        Path inputFile = Files.createTempDirectory("input");
        String inputSource = inputFile.toAbsolutePath().toString();

        String newFilePath = inputSource + "\\example2.xml";
